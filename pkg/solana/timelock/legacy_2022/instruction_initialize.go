...
const (
	...
	InitializeInstructionAccountsSize = (32 + // nonce
		32 + // timelock
		32 + // vault
		32 + // vaultOwner
		32 + // mint
...
func NewInitializeInstruction(
	...
	putUint64(data, args.UnlockDuration, &offset)
...
func InitializeInstructionFromBinary(data []byte) (*InitializeInstructionArgs, *InitializeInstructionAccounts, error) {
	...
	// Instruction Args
	getUint64(data, &args.UnlockDuration, &offset)

	// Instruction Accounts
	getKey(data, &accounts.Nonce, &offset)
