...
const (
	...
	tableCreate = `
	CREATE TABLE codewallet__core_airdropeligibility (
		...
		CONSTRAINT codewallet__core_airdropeligibility__uniq__owner UNIQUE (owner)
	);
	`

	// Used for testing ONLY, the table and migrations are external to this repository
	tableDestroy = `
		DROP TABLE codewallet__core_airdropeligibility;
	`
)
...
func TestAirdropPostgresStore(t *testing.T) {
