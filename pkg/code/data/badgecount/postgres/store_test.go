...
import (
	...
	"github.com/code-payments/code-server/pkg/code/data/badgecount/tests"
...
const (
	...
	tableCreate = `
	CREATE TABLE codewallet__core_badgecount (
		...
		CONSTRAINT codewallet__core_chat__uniq__owner UNIQUE (owner)
	);
	`

	// Used for testing ONLY, the table and migrations are external to this repository
	tableDestroy = `
		DROP TABLE codewallet__core_badgecount;
	`
)
...
func TestBadgeCountPostgresStore(t *testing.T) {
