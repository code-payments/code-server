...
const (
	...
	tableCreate = `
	CREATE TABLE codewallet__core_appuserpreferences (
		...
		CONSTRAINT codewallet__core_appuserpreferences__uniq__data_container_id UNIQUE (data_container_id)
	);
	`

	// Used for testing ONLY, the table and migrations are external to this repository
	tableDestroy = `
		DROP TABLE codewallet__core_appuserpreferences;
	`
)
...
func TestPreferencesPostgresStore(t *testing.T) {
